...
<body>
    <div class="container">
        <h2>글쓰기</h2>
        <form class="form-horizontal" action="/boardInsert" method="post" name="insertForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="content" name="content" placeholder="내용"></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="btn-group" role="group" style="float:right">
                ...
                <button type="button" onclick="document.insertForm.reset()" class="btn btn-default">취소</button>
